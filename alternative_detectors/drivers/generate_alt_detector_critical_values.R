...
T_grid <- parse_T_vector_arg(args$T_grid, default = c(1, 2, 5, 10, Inf))
finite_nrep <- parse_scalar_integer_arg(args$finite_nrep, default = 10000L)
open_nrep <- parse_scalar_integer_arg(args$open_nrep, default = 5000L)
...
output_path <- args$output %||% file.path(ROOT, "critical_values", "critical_values_alt_detectors.csv")
