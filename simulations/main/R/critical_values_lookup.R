...
candidate_main_cv_paths <- function(root) {
  repo_root <- dirname(dirname(root))
  list(
    base = unique(c(
      file.path(root, "critical_values", "critical_values_all.csv"),
      file.path(root, "outputs", "critical_values_all.csv"),
      file.path(repo_root, "critical_values", "main", "outputs", "critical_values_all.csv"),
      file.path(root, "critical_values", "main", "outputs", "critical_values_all.csv"),
      file.path(dirname(root), "critical_values", "main", "critical_values", "critical_values_all.csv"),
      file.path(dirname(dirname(root)), "critical_values", "main", "critical_values", "critical_values_all.csv")
    )),
    weights = unique(c(
      file.path(root, "critical_values", "critical_values_all_weights.csv"),
      file.path(root, "outputs", "critical_values_all_weights.csv"),
      file.path(repo_root, "critical_values", "main", "outputs", "critical_values_all_weights.csv"),
      file.path(root, "critical_values", "main", "outputs", "critical_values_all_weights.csv"),
      file.path(dirname(root), "critical_values", "main", "critical_values", "critical_values_all_weights.csv"),
      file.path(dirname(dirname(root)), "critical_values", "main", "critical_values", "critical_values_all_weights.csv")
    ))
  )
}
...
candidate_alt_cv_paths <- function(root) {
  ...
  unique(c(
    ...
    file.path(root, "outputs", "critical_values_alt_detectors.csv"),
    file.path(repo_root, "critical_values", "alternative_detectors", "outputs", "critical_values_alt_detectors.csv"),
    file.path(root, "critical_values", "alternative_detectors", "outputs", "critical_values_alt_detectors.csv"),
    file.path(dirname(root), "critical_values", "alternative_detectors", "critical_values", "critical_values_alt_detectors.csv"),
    file.path(dirname(dirname(root)), "critical_values", "alternative_detectors", "critical_values", "critical_values_alt_detectors.csv")
  ))
}
...
read_first_valid_csv <- function(paths, label) {
  ...
  stop(
    ...
    "\nGenerate public finite-horizon critical values with ",
    "`Rscript critical_values/main/run_generate_streamingcurve_cv.R` and, when needed, ",
    "`Rscript critical_values/alternative_detectors/run_generate_alt_detector_cv.R`."
  )
}
