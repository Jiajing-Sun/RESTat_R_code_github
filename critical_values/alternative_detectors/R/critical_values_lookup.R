...
candidate_main_cv_paths <- function(root) {
  ...
  list(
    base = unique(c(
      ...
      file.path(dirname(root), "main", "outputs", "critical_values_all.csv"),
      file.path(dirname(root), "main", "critical_values", "critical_values_all.csv"),
      file.path(dirname(dirname(root)), "main", "critical_values", "critical_values_all.csv")
    )),
    weights = unique(c(
      ...
      file.path(dirname(root), "main", "outputs", "critical_values_all_weights.csv"),
      file.path(dirname(root), "main", "critical_values", "critical_values_all_weights.csv"),
      file.path(dirname(dirname(root)), "main", "critical_values", "critical_values_all_weights.csv")
    ))
  )
}
...
candidate_alt_cv_paths <- function(root) {
  ...
  unique(c(
    ...
    file.path(dirname(root), "alternative_detectors", "outputs", "critical_values_alt_detectors.csv"),
