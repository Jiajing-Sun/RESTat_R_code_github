...
mosum_h_vec <- parse_numeric_vector_arg(args$mosum_h_vec, default = c(0.10, 0.20))
weighted_cusum_omega_names <- parse_character_vector_arg(args$weighted_cusum_omega_names, default = c("InvSqrt"))
multiscale_h_sets <- list(H050_100_200 = c(0.05, 0.10, 0.20))
multiscale_scale_names <- parse_character_vector_arg(args$multiscale_scale_names, default = c("Equal"))
...
open_pair_lag_grid_size <- parse_scalar_integer_arg(args$open_pair_lag_grid_size, default = 40L)
finite_eval_grid_size <- parse_scalar_integer_arg(args$finite_eval_grid_size, default = 250L)
open_eval_grid_size <- parse_scalar_integer_arg(args$open_eval_grid_size, default = 250L)
exact_page_scan <- parse_bool_arg(args$exact_page_scan, default = FALSE)
exact_weighted_scan <- parse_bool_arg(args$exact_weighted_scan, default = FALSE)
...
batch_size <- parse_scalar_integer_arg(args$batch_size, default = 100L)
...
seed_finite <- parse_scalar_integer_arg(args$seed_finite, default = 24681357L)
seed_openend <- parse_scalar_integer_arg(args$seed_openend, default = 97531L)
...
OUTPUT_DIR <- args$output_dir %||% file.path(ROOT, "outputs"); ensure_dir(OUTPUT_DIR)
