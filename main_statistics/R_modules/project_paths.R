...
find_project_root <- function(start = NULL,
                              markers = c("run_null_streamingcurve_simulation.R", file.path("R", "project_paths.R"), file.path("critical_values", "critical_values_all.csv"))) {
  ...
  stop(
    ...
    "or pass --root=/path/to/streaming_curve_latest_sim_codes."
  )
}
